...
<body class="bg-[#F7F8F9]">
    <div>
        @include('layout.headerLogin')
            <div class="flex flex-row mt-[220px] ml-[100px] justify-center">
                <div class="">
                    ...
                    <h3>Possible Goal:</h3>
                    <div class='text-[16px] font-cairo flex flex-col mt-5 mb-[200px]'>
                ...
                <div class="flex flex-row ml-[100px] h-[600px] -mt-[50px] justify-center">
                    <div class="flex flex-col border shadow-sm rounded-lg p-10  ">
                        ...
                        <div class="flex justify-center flex-col w-full px-[50px]">
                            <h4 class="mt-8 text-[#333F51]">Email</h4>
                            <input type="text" class="w-full rounded-md shadow-md mt-2 p-3 placeholder:-pl-[600px]" placeholder="Enter your email adress">
                            ...
                            <button class="w-full rounded-lg hover:bg-[#d9dde3] mt-5 border p-3 text-[#556987] flex flex-row text-center justify-center  shadow-md "><span><img class="h-[25px] mr-2" src="/image/fb.png" alt=""></span>Sign in with Facebook</button>
                            <button class="w-full rounded-lg hover:bg-[#d9dde3] mt-5 border p-3 text-[#556987] flex flex-row text-center justify-center  shadow-md "><span><img class="h-[25px] mr-2" src="/image/apple.png" alt=""></span>Sign in with Apple</button>
                            <h4 class="text-center mt-5 text-[14px] font-medium">Already have an account? <span class="text-[#22C55E] hover:text-[#1eae53]"><a href="/loginMenu">Sign in</a></span></h4>
                        </div>
                    </div>
                </div>
            </div>
